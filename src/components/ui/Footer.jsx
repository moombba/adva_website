    ...
    <footer id="contact" className="py-24 px-8 md:px-24 border-t border-[#333333]/5 mt-32 text-[#333333]">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 mb-32">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 text-sm font-bold font-display">
              <a href="https://www.linkedin.com/in/adva-atelier-des-verre-et-acier-architectes-897910260/" target="_blank" rel="noopener noreferrer" className="hover:opacity-60 transition-opacity flex items-center gap-2">
        ...
        <div className="w-full h-[400px] bg-[#333333]/5 grayscale hover:grayscale-0 transition-all duration-1000 overflow-hidden relative border border-[#333333]/10">
          <iframe 
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-8 opacity-20 text-[10px] uppercase tracking-[0.4em] font-bold font-display pt-16 border-t border-[#333333]/5">
        ...
        <div className="flex gap-12">
          ...
          <a href="#hero" className="hover:opacity-100 transition-opacity">Retour en haut ↑</a>
        </div>
      </div>
    </footer>
  );
